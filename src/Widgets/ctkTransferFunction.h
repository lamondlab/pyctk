...
/// used
struct CTK_EXPORT ctkControlPoint
{
...
//-----------------------------------------------------------------------------
/// \ingroup Widgets
struct CTK_EXPORT ctkBezierControlPoint : public ctkControlPoint
{
...
//-----------------------------------------------------------------------------
/// \ingroup Widgets
struct CTK_EXPORT ctkNonLinearControlPoint : public ctkControlPoint
{
...
//-----------------------------------------------------------------------------
/// \ingroup Widgets
class CTK_EXPORT ctkTransferFunction: public QObject
{
  Q_OBJECT
public:
