 ...
 */
class CTK_EXPORT ctkException : public std::exception, public ctkBackTrace
{
public:
 ...
 * \ingroup Core
 */
CTK_EXPORT QDebug operator<<(QDebug dbg, const ctkException& exc);

//---------------------------------------------------------------------------
/**
 * \ingroup Core
 */
CTK_EXPORT QDebug operator<<(QDebug dbg, const ctkException::TraceManipulator& trace);
...
CTK_DECLARE_EXCEPTION(CTK_EXPORT, ctkUnsupportedOperationException, ctkException)
CTK_DECLARE_EXCEPTION(CTK_EXPORT, ctkRuntimeException, ctkException)
CTK_DECLARE_EXCEPTION(CTK_EXPORT, ctkInvalidArgumentException, ctkRuntimeException)
CTK_DECLARE_EXCEPTION(CTK_EXPORT, ctkIllegalStateException, ctkRuntimeException)
