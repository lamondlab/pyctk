...
//-----------------------------------------------------------------------------
struct CTK_EXPORT ctkWorkflowIntrastepTransitionEvent : public QEvent
{
...
//-----------------------------------------------------------------------------
/// \ingroup Core
class CTK_EXPORT ctkWorkflowIntrastepTransition : public QAbstractTransition
{
  Q_OBJECT
...
//-----------------------------------------------------------------------------
/// \ingroup Core
struct CTK_EXPORT ctkWorkflowInterstepTransitionEvent : public QEvent
{
...
//-----------------------------------------------------------------------------
/// \ingroup Core
class CTK_EXPORT ctkWorkflowInterstepTransition : public QAbstractTransition
{
  Q_OBJECT
